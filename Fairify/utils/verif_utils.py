...
def load_crime():
    filepath = '../../data/crime/crime.data'
    column_names = ['day', 'community', 'category',
                'amount', 'Adj0', 'Adj1', 'Adj2', 'Adj3',
                'Adj4', 'Adj5',
                'Adj6', 'Adj7', 'Adj8', 'Adj9',
                'Adj10', 'Adj11', 'Adj12',
                'Adj13', 'Adj14', 'Adj15',
...
def in_const_crime(df, x, var_name, op, rhs):
    label_name = 'amount'
    dataframe = df.drop(labels = [label_name], axis=1, inplace=False)
    props = []
    for col in dataframe:
...
def in_const_domain_crime(df, x, x_, ranges, PA):
    label_name = 'amount'
    dataframe = df.drop(labels = [label_name], axis=1, inplace=False)
    #dataframe = df.drop(df.columns[len(df.columns)-1], axis=1, inplace=False)
    props = []
...
def in_const_diff_crime(df, x, x_, var_name, threshold):
    label_name = 'amount'
    dataframe = df.drop(labels = [label_name], axis=1, inplace=False)
    props = []
    for col in dataframe:
