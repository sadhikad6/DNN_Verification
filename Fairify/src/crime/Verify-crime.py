...
df, X_train, y_train, X_test, y_test = load_crime()
X = np.r_[X_train, X_test]
single_input = X_test[0].reshape(1, 20)
#print_metadata(df)

# In[]
model_dir = '../../models/crime/'
result_dir = './community-'
...
default_range = [0, 1]
range_dict = {}
range_dict['day'] = [0, 365]
range_dict['community'] = [0, 76]
range_dict['category'] = [0, 8]
range_dict['Adj0'] = [0, 76]
range_dict['Adj1'] = [0, 76]
range_dict['Adj2'] = [0, 76]
range_dict['Adj3'] = [0, 76]
range_dict['Adj4'] = [0, 76]
range_dict['Adj5'] = [0, 76]
range_dict['Adj6'] = [0, 76]
range_dict['Adj7'] = [0, 76]
range_dict['Adj8'] = [0, 76]
range_dict['Adj9'] = [0, 76]
range_dict['Adj10'] = [0, 76]
range_dict['Adj11'] = [0, 76]
range_dict['Adj12'] = [0, 76]
range_dict['Adj13'] = [0, 76]
range_dict['Adj14'] = [0, 76]
range_dict['Adj15'] = [0, 76]
range_dict['Adj16'] = [0, 76]
...
for model_file in model_files:
    ...
    #    sd = s
        neuron_bounds, candidates, s_candidates, b_deads, s_deads, st_deads, pos_prob, sim_X_df  = \
            sound_prune_crime(df, w, b, simulation_size, layer_net, p)
        ...
        for attr in A:
            if(attr in PA):
                in_props.extend(in_const_crime(df, x, attr, 'neq', x_))
            elif(attr in RA):
                in_props.extend(in_const_diff_crime(df, x, x_, attr, RA_threshold))
            else:
                in_props.extend(in_const_crime(df, x, attr, 'eq', x_))
    
        in_props.extend(in_const_domain_crime(df, x, x_, p, PA))
